...
function UserManagement() {
  ...
  const displayedTasks = users?.slice(startIndex, endIndex);
  console.log("u", users)
  console.log("DT",displayedTasks)
  return (
    <>
      <ToastContainer />
        <div className='page_title flex_between' >
          ...
          <div className='add_task_btn' style={{width:'5rem'}}>
            ...
            <Link style={{color : 'white'}} to='/signup'>Add</Link>
          </div>
        </div>
        <div className="user_header">
            ...
            <div className="tasks_body">
              { 
                displayedTasks?.map((user,ind)=>{
                  return(<>
                    <div className="user_elem">
                      <div className="user_elem_child">{ind+1}</div>
                      <div className="user_elem_child">{user.username}</div>
                      <div className="user_elem_child">{user.email}</div>
                      <div className="user_elem_child">{user.role}</div>
                      <div className="user_elem_child">{user?.createdAt}</div>
                      <div className="user_elem_child"> ******** </div>
                      <div className="user_elem_child gap20" >
                        <svg onClick={() => handleUpdate(user._id)} width="20" height="20" viewBox="0 0 27 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg onClick={() => handleDelete(user._id)} width="20" height="20" viewBox="0 0 25 27" fill="none" xmlns="http://www.w3.org/2000/svg">
