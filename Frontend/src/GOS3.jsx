      ...
      <div className="g1_body1">
        <div>
          ...
          <div style={{padding: "0px 29px"}} >
            <div className="flex4" >
              <div className="txt4">DV voucher type: </div>
              <select className='form_input2' placeholder='Select' style={{cursor:'pointer',marginBottom: '0',width:'3rem',height:'1.7rem'}} >
            ...
            <div className="flex4" >
              <div className="txt4">NV voucher type: </div>
              <select className='form_input2' placeholder='Select' style={{cursor:'pointer',marginBottom: '0',width:'3rem',height:'1.7rem'}} >
                <option value="0"></option>
              </select>            
              <input type="checkbox" name="" id="" />
          ...
          <div style={{padding: "0px 29px"}} >
            ...
            <div className="practitioner_label" style={{marginBottom:'1rem'}} >
              Practitioner
            </div>
            <div className='g1_b1_left1' style={{padding:'0'}} >
              <div className='g1_b1_ll' >                            
                <div>
                  <div className="input_label">
                    Optom Title
            ...
            <div className="add_sig_btn" style={{margin:'1rem 0'}} >
              Load Optom Details
            </div>
          </div>
        ...
        <div className="g1_b1_right">
          <div className="g1_b1_left2" style={{padding:'16px 0px'}}>
            <div>
          ...
          <div>            
            ...
            <div className="box_elem_1">
              ...
              <div>
                ...
                <select className='form_input2' placeholder='Select' style={{cursor:'pointer',marginBottom: '0'}} >
                  <option value="0">No change in prescription</option>
                </select>
              </div>              
            </div>
            ...
            <div className="flex4" >
              <div className="txt4">1st pair: </div>
              <select className='input_5' placeholder='Select' style={{cursor:'pointer',marginBottom: '0',width:'3rem',height:'1.7rem'}} >
                <option value="0"></option>
              </select>            
              <select className='input_5' placeholder='Select' style={{cursor:'pointer',marginBottom: '0',width:'3rem',height:'1.7rem'}} >
                <option value="0"></option>
              ...
              <input type="checkbox" name="" id="" />
              <div className='ptxt2' >Small</div>                            
              <input type="checkbox" name="" id="" />
              <div className='ptxt2' >Special</div>
            </div>
            <div className="flex4" >
              <div className="txt4">2st pair: </div>
              <select className='input_5' placeholder='Select' style={{cursor:'pointer',marginBottom: '0',width:'3rem',height:'1.7rem'}} >
                <option value="0"></option>
              </select>            
              <select className='input_5' placeholder='Select' style={{cursor:'pointer',marginBottom: '0',width:'3rem',height:'1.7rem'}} >
            ...
            <div>
              <div className="col_date_row" style={{marginTop: '2rem'}} >
                <div className="cdr_e1">
                  Collection date
                </div>
                <div>1</div>
                <input type="date" name="" id="" className='input_5' style={{width:'7rem'}} />
                <div>2</div>
                <input type="date" name="" id="" className='input_5' style={{width:'7rem'}} />
              </div>
              <div className="col_date_row">
                <div className="cdr_e1">
                  Sale Price
                </div>
                <div>1</div>
                <input type="text" placeholder='$ 0.00' name="" id="" className='input_5' style={{width:'7rem',textAlign:'left',paddingLeft:'5px'}} />
                <div>2</div>
                <input type="text" placeholder='$ 0.00' name="" id="" className='input_5' style={{width:'7rem',textAlign:'left',paddingLeft:'5px'}} />                
              </div>
              <div className="col_date_row">
              ...
              <div style={{display:'flex',alignItems:'center',marginBottom:'1rem'}} >
                <div className="mini_txt5">
                  Issue
                </div>
                <div className='normal_txt5' >
                  Voucher Code
                </div>
                <input type="text" name="" id="" className='input_5' style={{width:'4rem',textAlign:'left',paddingLeft:'5px'}} />
                <div style={{display:'flex',alignItems:'center',justifyContent:'center'}} >
                  <div className="till_ni_btn" style={{borderRadius: '4px',marginLeft: '1rem'}}>
                    Receive
                  </div>
                </div>
              </div>
