...
function PatientNew() {
  ...
  const [promotionalCommunication, setPromotionalCommunication] = useState(false);
  ...
  const handleSavePatient = () => {
    ...
    const patientForm = {
      title, forename, surname, dob, address1, address2, city, country, postcode, email, landline, mobile, gender, doctor, patientType, HC2orHC3Number, HC3PatientContribution, patientHasGlucoma, patientHasDiabetic, contactedBy, promotionalCommunication, notes 
    }
    setLoading(true)

    axios.post(`${baseUrl}/api/patient`, patientForm).then(res => {
      console.log(res);
      notify();
       setLoading(false)
  ...
  const handleContactBy = (e) => {
    console.log(e.target.name)
     if(!contactedBy.includes(e.target.name)) {
        console.log('in1')
        contactedBy.push(e.target.name)
     }
     else {
      console.log('in2')
      
        const toRemoveIdx = contactedBy.findIndex(o => {
          return e.target.name
        });
        contactedBy.splice(toRemoveIdx, 1);
     }
  }
            ...
            report2 && <>
              <div className='pn_mini_header_p2'>
                ...
                <div style={{display:'flex',alignItems:'center',gap:'0.5rem'}} >
                  <div >
                    <div className="input_label" style={{fontSize:'14px',fontWeight:'600'}} >Patient ID</div>
                    <div className='pn_mini_lb' >12345</div>
                  </div>
                  <div>
                    <div className="input_label" style={{fontSize:'14px',fontWeight:'600'}} >Patient Name</div>
            ...
            <div className="report_body1" style={{height:'auto'}} >
              ...
              <div className="pn_flex_con1">
                <div>
                    ...
                    <input type="text" className='pn_input_form' placeholder='Type here' 
                    onChange={(e) => setTitle(e.target.value)}/>
                </div>
                <div>
                    <div className="input_label">Forename</div>
                    <input type="text" className='pn_input_form' placeholder='John' onChange={(e) => setForename(e.target.value)}/>
                </div>
                <div>
                    <div className="input_label">Surname</div>
                    <input type="text" className='pn_input_form' placeholder='Smith' onChange={(e) => setSurname(e.target.value)}/>
                </div>
              </div>
              <div className="pn_flex_con1">
                <div>
                    <div className="input_label">DoB</div>
                    <input type="date" className='pn_input_form' placeholder='Type here' onChange={(e) => setDob(e.target.value)}/>
                </div>
                <div>
                    <div className="input_label">Address 1</div>
                    <input type="text" className='pn_input_form' placeholder='Type here' onChange={(e) => setAddress1(e.target.value)}/>
                </div>
                <div>
                    <div className="input_label">Address 2</div>
                    <input type="text" className='pn_input_form' placeholder='Type here' onChange={(e) => setAddress2(e.target.value)}/>
                </div>
              </div>
              <div className="pn_flex_con1">
                <div>
                    <div className="input_label">Town/City</div>
                    <input type="text" className='pn_input_form' placeholder='Type here' onChange={(e) => setCity(e.target.value)}/>
                </div>
                <div>
                    <div className="input_label">Country</div>
                    <input type="text" className='pn_input_form' placeholder='Type here' onChange={(e) => setCountry(e.target.value)}/>
                </div>
                <div>
                    <div className="input_label">Postcode</div>
                    <input type="text" className='pn_input_form' placeholder='Type here' onChange={(e) => setPostcode(e.target.value)}/>
                </div>
              </div>
              <div className="pn_flex_con1">
                <div>
                    <div className="input_label">Email</div>
                    <input type="email" className='pn_input_form' placeholder='abcd@gmail.com' onChange={(e) => setEmail(e.target.value)}/>
                </div>
                <div>
                    <div className="input_label">Landline</div>
                    <input type="text" className='pn_input_form' placeholder='12345678' onChange={(e) => setLandline(e.target.value)}/>
                </div>
                <div>
                    <div className="input_label">Mobile</div>
                    <input type="text" className='pn_input_form' placeholder='+0123456789' onChange={(e) => setMobile(e.target.value)}/>
                </div>
              </div>
              <div className="pn_flex_con1">
                <div>
                    <div className="input_label">Gender</div>
                    <select name="gender" id="gender" value={gender} onChange={(e) => setGender(e.target.value)} className='pn_input_form'>
                ...
                <div>
                    ...
                    <input type="text" className='pn_input_form' placeholder='Type here' onChange={(e) => setDoctor(e.target.value)}/>
                </div>
                <div>
                    <div className="input_label">Patient Type</div>
                    <select name="patientType" id="patientType" value={patientType} onChange={(e) => setPatientType(e.target.value)} className='pn_input_form'>
                    <option value="">Select</option>
              ...
              <div className="pn_flex_con1">
                <div>
                    ...
                    <input type="text" className='pn_input_form' placeholder='Type here' onChange={(e) => setHC2orHC3Number(e.target.value)}/>
                </div>
                <div>
                    <div className="input_label">HC3 Patient Contribution ( $ )</div>
                    <input type="text" className='pn_input_form' placeholder='Type here' onChange={(e) => setHC3PatientContribution(e.target.value)}/>
                </div>
                <div>
                    <div className="pn_two_rt">
                      <div>
                        <input type="checkbox" name="" id="" onChange={(e) => setPatientHasGlucoma(e.target.checked)}/>
                        <div className="input_label" style={{margin:'0'}} >Patient has Glaucoma</div>
                      </div>
                      <div>
                        <input type="checkbox" name="" id="" onChange={(e) => setpatientHasDiabetic(e.target.checked)}/>
                        <div className="input_label" style={{margin:'0'}} >Diabetic</div>
                      </div>
                    </div>
                </div>
              </div>
              ...
              <div className="pn_two_rt2">
                <div>
                  <input type="checkbox" name="sms" id="" onChange={handleContactBy}/>
                  <div className="input_label" style={{margin:'0'}} >SMS</div>
                </div>
                <div>
                  <input type="checkbox" name="phone" id="" onChange={handleContactBy}/>
                  <div className="input_label" style={{margin:'0'}} >Phone</div>
                </div>
                <div>
                  <input type="checkbox" name="email" id="" onChange={handleContactBy}/>
                  <div className="input_label" style={{margin:'0'}} >Email</div>
                </div>
                <div>
                  <input type="checkbox" name="post" id="" onChange={handleContactBy}/>
                  <div className="input_label" style={{margin:'0'}} >Post</div>
                </div>
              </div>
              <div className="input_label" style={{marginTop:'1rem'}} >Are you happy to receive promotional communication?</div>
              <div className="pn_two_rt2">
                <div>
                  <input type="radio" name="yes" id="" onChange={handlePromotionsInput}/>
                  <div className="input_label" style={{margin:'0'}}>Yes</div>
                </div>
                <div>
                  <input type="radio" name="no" id="" onChange={handlePromotionsInput}/>
                  <div className="input_label" style={{margin:'0'}} >No</div>
                </div>
              </div>
              <div className="input_label" style={{marginTop:'1rem'}} >Notes</div>
              <textarea name="" id="" cols="30" rows="10" className='pn_input_form' style={{width:'100%',height:'4rem',padding:'5px'}} placeholder='Lorem ipsum dolor sit amet, consectetur adipiscing elit' onChange={e => setNotes(e.target.value)}></textarea>
               {msg && <p style={{color : 'red'}}>{msg}</p>}
              <div className="cl_btn_con" style={{marginTop:'1rem'}} >
                <div className="save_btn" onClick={handleSavePatient}>Save</div>
              </div>
            </div>

            <div className="report_body1" style={{height:'auto',marginTop:'2rem'}}>
              <div className="patient_footer">
                <NavLink to='/new-sight-test' className="patient_footer_elem">
                  <svg width="31" height="15" viewBox="0 0 31 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div onClick={()=>{setnewAttach(true)}} className="patient_footer_elem">
                  <svg width="32" height="16" viewBox="0 0 32 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M25.397 7.94069C24.478 3.41263 20.5405 0 15.75 0C11.9439 0 8.66263 2.16549 7.02201 5.31569C3.08451 5.70951 0 9.05612 0 13.125C0 17.456 3.54368 21 7.875 21H24.9375C28.5469 21 31.5 18.0469 31.5 14.4375C31.5 10.9595 28.8096 8.13743 25.397 7.94069ZM17.85 11.8125V16.8H13.65V11.8125H9.1875L15.75 5.25L22.3125 11.8125H17.85Z" fill="#4C004A"/>
                  </svg>
        ...
        { report2? (
          <>
            <div className="pn_h2_mini" >
                <div className="mini_header" style={{margin:'0',fontSize:'16px'}}>Sight Test History</div>
                <div className="pn_flex_mini2">
                  <div className="input_label" style={{margin:'0'}} >Date:</div>
                  <input type="date" placeholder='12/08/2023' className='pn_input_form2' />
                </div>
            </div>
            <div className="pn_header1 pn_header1_modified" style={{gridTemplateColumns: '8% 9% 7% 70% 6%'}} >
            ...
            <div className="pn_body2 pn_body2_modified" style={{height:'auto',padding:'35px 0',gridTemplateColumns:'8% 9% 7% 70% 6%'}}>
              ...
              <div className='flex' style={{grid:'7px'}} >
                <svg width="27" height="16" viewBox="0 0 27 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg width="25" height="17" viewBox="0 0 25 29" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="pn_h2_mini" >
                <div className="mini_header" style={{margin:'0',fontSize:'16px'}}>Contact Lens History</div>
                <div className="pn_flex_mini2">
                  <div className="input_label" style={{margin:'0'}} >Date:</div>
                  <input type="date" placeholder='12/08/2023' className='pn_input_form2' />
                </div>
            ...
            <div className="pn_body2" style={{height:'auto',padding:'35px 0'}}>
              <div className='flex' >1234</div>
              <div className='flex' >12/08/2023</div>
              <div className='flex' >$26.6</div>
              <div>
                <div className="input_label" style={{margin:'0'}} >Final RX</div>
                <div className='pn_con22' >
                  <div className="rl_item2">
                    <div className="pn_item_r1_2"></div>
                    <div className="pn_item_r1_2" style={{alignItems: 'center'}} >R:</div>
                    <div className="pn_item_r1_2" style={{alignItems: 'center'}} >L:</div>
                  </div>                                      
                  <div className="rl_item2">
                  ...
                  <div className="rl_item2">
                    <div className="pn_item_r1_2" style={{alignItems: 'end'}} >Add</div>
                    <div className="pn_item_r1_2">
                      <input type="text" name="" id="" className='input_5_2'  placeholder='' />
                    </div>
                    <div className="pn_item_r1_2">
                  ...
                  <div className="rl_item2">
                    <div className="pn_item_r1_2" style={{alignItems: 'end'}} >BC</div>
                    <div className="pn_item_r1_2">
                      <input type="text" name="" id="" className='input_5_2' placeholder='' />
                    </div>
                    <div className="pn_item_r1_2">
                  ...
                  <div className="rl_item2">
                    <div className="pn_item_r1_2" style={{alignItems: 'end'}} >Diameter</div>
                    <div className="pn_item_r1_2">
                      <input type="text" name="" id="" className='input_5_2'  placeholder='' /> 
                    </div>
                    <div className="pn_item_r1_2">
            ...
            <div className="pn_h2_mini" >
                <div className="mini_header" style={{margin:'0',fontSize:'16px'}}>Dispensing History</div>
                <div className="pn_flex_mini2">
                  <div className="input_label" style={{margin:'0'}} >Date:</div>
                  <input type="date" placeholder='12/08/2023' className='pn_input_form2' />
                </div>
            </div>
            <div className="pn_header1" style={{gridTemplateColumns:'15% 15% 15% 15% 15% 14% 11%'}}>
              <div className='flex' >Record ID</div>
              <div className='flex' >Test Date</div>
              <div className='flex' >Payment</div>
            ...
            <div className="pn_body2" style={{height:'auto',padding:'35px 0',gridTemplateColumns:'15% 15% 15% 15% 15% 14% 11%'}}>
              <div className='flex' >1234</div>
              <div className='flex' >12/08/2023</div>
              <div className='flex' >$26.6</div>
                ...
                <div className="make_a_con">
                    ...
                    <div className="flex">                        
                        <svg width="453" height="200" viewBox="0 0 453 331" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_824_9245"/>
                                <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_824_9245" result="shape"/>
                                </filter>
                                <linearGradient id="paint0_linear_824_9245" x1="226.5" y1="114" x2="226.5" y2="346.666" gradientUnits="userSpaceOnUse">
                                <stop stop-color="#C8D1E5" stop-opacity="0"/>
                                <stop offset="1" stop-color="#C8D1E5" stop-opacity="0.03"/>
                                </linearGradient>
                                <linearGradient id="paint1_linear_824_9245" x1="223" y1="144" x2="223" y2="178" gradientUnits="userSpaceOnUse">
                    ...
                    <div style={{display:'flex',justifyContent:'center',alignItems:'center'}} >
                        <div className='till_ni_btn' style={{padding:'7px 16px',cursor:'pointer',marginTop:'2rem'}} >Upload</div>
                    </div>
                    <svg className='login_xmark' onClick={()=>{setnewAttach(false)}} xmlns="http://www.w3.org/2000/svg" fill='#e3e3e3' height="1.5em" viewBox="0 0 512 512"><style></style><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM175 175c9.4-9.4 24.6-9.4 33.9 0l47 47 47-47c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9l-47 47 47 47c9.4 9.4 9.4 24.6 0 33.9s-24.6 9.4-33.9 0l-47-47-47 47c-9.4 9.4-24.6 9.4-33.9 0s-9.4-24.6 0-33.9l47-47-47-47c-9.4-9.4-9.4-24.6 0-33.9z"/></svg>
                </div>
          </div>
        }
    </>
