  ...
  return (
    <>
      <div className="patient-div">
        <div className="page_title" style={{ marginBottom: "1rem" }}>
          New Patient
        </div>
        <div className="inner-patient-div">
          <div className="headings">
            ...
            >
              <div className="n-p-t" onClick={statechange}>
                New Patient
              </div>
            </div>
            <div
            ...
            >
              <div className="e-p-r" onClick={statechange2}>
        ...
        <div className="create-new-patient-div">
          ...
          <div className="input-big-box">
            ...
            <div className="input-small-box">
              ...
              <div class="form-group">
                <div className="label">
                  <label htmlFor="selectOptionPatientType">
                    {" "}
                    Patient Type{" "}
                  </label>
                </div>
