      ...
      {report1 ? (
        <>
          <div className="report_body1 padd_com" style={{ height: "auto" }}>
            <div className="mini_header">Manual Recall</div>
            <div className="rb2_bottom">
              <div>
                <div className="input_label">Practice</div>
                <select
              ...
              <div>
                <div className="input_label">Full or CL Examination Due</div>
                <select
                  className="form_input"
                  placeholder="Select"
                  style={{ cursor: "pointer" }}
            ...
            <div className="rb2_bottom">
              <div>
                <div className="input_label">Recall Date Start</div>
                <input
                  type="date"
                  className="form_input"
                  placeholder="12/1/2023"
              ...
              <div>
                <div className="input_label">Recall Date End</div>
                <input
                  type="date"
                  className="form_input"
                  placeholder="12/1/2023"
            ...
            <div className="rb2_bottom">
              <div>
                ...
                <input type="text" className="form_input" placeholder="1023" />
              </div>
              <div>
            ...
            <div className="rb2_bottom">
              ...
              <div>
                <div className="input_label">Post Code</div>
                <input type="text" className="form_input" placeholder="09023" />
              </div>
            </div>
            <div className="rb2_bottom">
              <div>
            ...
            <div
              className="add_sig_btn task2_submit_btn"
              style={{
                margin: "0",
                fontSize: "11px",
                right: "7.5rem",
        ...
        <>
          <div className="report_body1 padd_com" style={{ height: "auto" }}>
            ...
            <div className="rb2_bottom">
              ...
              <div>
                <div className="input_label">Patient ID in Range</div>
      ...
      {report3 ? (
        <>
          <div className="dispensing_body1">
            <div className="mini_header">Recall History - Spectacle Recall</div>
            <div className="rb2_bottom">
              <div>
                <div className="input_label">Start Date</div>
                <input
          ...
          <div
            className="appoint_header2"
            style={{
              marginTop: "3rem",
              gridTemplateColumns: "18% 20% 24% 9% 9% 20%",
            }}
          >
          ...
          <div className="report_body2" style={{ paddingBottom: "5rem" }}>
            <div
              className="appoint_elem"
              style={{ gridTemplateColumns: "18% 20% 24% 9% 9% 20%" }}
            >
              ...
              <div className="body2_elem_child b2ec_last">
                ...
                >
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M12.3625 6.57199L16.4277 10.6382L6.94025 20.1247H2.875V16.0585L12.3625 6.57104V6.57199ZM13.7178 5.217L15.7504 3.18342C16.1247 2.8093 16.7313 2.8093 17.1055 3.18342L19.8166 5.89454C20.1908 6.26877 20.1908 6.8754 19.8166 7.24963L17.7831 9.28225L13.7178 5.217Z"
                    fill="#405189"
                  />
                </svg>
                <svg
