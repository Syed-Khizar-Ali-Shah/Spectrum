...
const NewCLTest = () => {
  ...
  return (
    <>
      ...
      <div className="report_header" style={{marginTop:'1rem',paddingLeft:'1rem'}} >C/L FIT</div>
      <div className="nst_body padd_com" style={{height: 'auto'}}>
        ...
        <div className="grid2_con" style={{marginTop:'1rem'}} >
            <div>
                ...
                <div className="p4_mini_dual width_prob_c2" style={{marginBottom:'0.5rem'}} >
                    <div style={{display:'flex',alignItems:'center'}}>
                      <div className="p4_txt1 ml0_1">RE-H:</div>
                      <input type="text" name="" id="" className='p4_input1' placeholder='' />
                    </div>
                    <div style={{display:'flex',alignItems:'center'}}>
                      <div style={{marginLeft:'0.5rem'}} className="p4_txt1 ml0_1">RE-V:</div>
                      <input type="text" name="" id="" className='p4_input1' placeholder='' />
                    </div>
                </div>
                <div className="p4_mini_dual width_prob_c2">
                    ...
                    <div style={{display:'flex',alignItems:'center'}} >
                      <div style={{marginLeft:'0.5rem'}} className="p4_txt1 ml0_1">LE-V:</div>
                      <input type="text" name="" id="" className='p4_input1' placeholder='' />
                    </div>
                </div>
            </div>
        ...
        <div className='cl_con1' >
            ...
            <div className="rl_item2">
              ...
              <div className="rl_item_r1_2">
                <input type="text" name="" id="" className='input_5_2' placeholder='' style={{width:'3.5rem',height:'4.2rem',marginTop: '0.6rem',marginBottom: '0.6rem'}} />
              </div>
              {/* <div className="rl_item_r1_2">
                <input type="text" name="" id="" className='input_5_2' placeholder='' />
              </div> */}
        ...
        <div className="grid2_con2">
            <div>
                ...
                <div className="input_label" style={{marginTop:'1rem'}} >Solutions</div>
                <textarea name="" id="" cols="30" rows="10" className='cl_ta' placeholder='Type here' ></textarea>
            </div>
            <div>
